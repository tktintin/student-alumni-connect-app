...
import { getProfilesByNameSearch } from '../../../src/store/filter/selectors';

const mockFiltered = {
    profilesByNameSearch: [
        {
            "UserID":1,
...
describe('Test getProfilesByNameSearch selector', () => {
    it('Should return result of type object', () => {
        const selected = getProfilesByNameSearch.resultFunc(mockFiltered);
