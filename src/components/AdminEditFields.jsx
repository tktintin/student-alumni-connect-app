...
/**
    ...
    ***Description**
    ...
    This is a form component for editing information 
    about an existing user, specific to the Admin Console.
...
const AdminEditFields = ({ queriedUser, setAfterFind }) => {

    const user = queriedUser?.find(e => !!e);
    ...
    const [update_ProfilePic, set_update_ProfilePic] = useState("");
    ...
    const editData_UserTable = {
        ...
        "ProfilePic": (update_ProfilePic === "" ? edit_ProfilePic : update_ProfilePic),
        ...
        "Email": (update_Email === "" ? edit_Email : update_Email),
    ...
    const editData_EducationTable = {
        ...
        "ClassYear": (update_ClassYear === "" ? (edit_ClassYear !== 0 ? (edit_ClassYear === "" ? 0 : edit_ClassYear) : 0) : parseInt(update_ClassYear)),
        ...
        "OtherEduClassYear": (update_OtherEduClassYear === "" ? (edit_OtherEduClassYear !== 0 ? (edit_OtherEduClassYear === "" ? 0 : edit_OtherEduClassYear) : 0) : parseInt(update_OtherEduClassYear)),
    }
