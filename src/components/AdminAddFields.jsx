...
/**
    ...
    ***Description**
    ...
    This is a form component for new user registration, 
    specific to the Admin Console.
    ...
    ***Structure**
    ...
    This component contains a 3-part form, called a stepper;
    with buttons for ```continue, back, submit```.
    ...
    ***Functions**
    ...
    A dispatch function to ```POST``` newly added form data ```editData_AdminInsertTable```
    using api call attached to ```performadminInsertTableRepository``` function.
    ```jsx
